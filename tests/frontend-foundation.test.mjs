...
test("foundation pages consume shared components instead of duplicating primitives", () => {
  for (const page of ["src/app/page.tsx", "src/app/financas/page.tsx"]) {
